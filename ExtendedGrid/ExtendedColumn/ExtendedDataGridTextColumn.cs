...
namespace ExtendedGrid.ExtendedColumn
{
    public class ExtendedDataGridTextColumn : DataGridTextColumn, IExtendedColumn
    {
        ...
        public static readonly DependencyProperty SummaryColumnSettingsProperty = DependencyProperty.Register(
           "SummaryColumnSettings", typeof(SummaryColumnSettings), typeof(ExtendedDataGridTextColumn));

        public static readonly DependencyProperty AllowAutoFilterProperty = DependencyProperty.Register(
          "AllowAutoFilter", typeof(Boolean), typeof(ExtendedDataGridTextColumn), new PropertyMetadata(true));

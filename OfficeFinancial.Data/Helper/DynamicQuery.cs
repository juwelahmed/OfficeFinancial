...
namespace OfficeFinancial.Data.Helper
{
    ...
    public sealed class DynamicQuery
    {
        ...
        {
            var queryProperties = new List<QueryParameter1>();
            ...
            {
                QueryParameter1 item = queryProperties[i];
        ...
        private static void WalkTree(BinaryExpression body, ExpressionType linkingType,
                                     ref List<QueryParameter1> queryProperties)
        {
            if (body.NodeType != ExpressionType.AndAlso && body.NodeType != ExpressionType.OrElse)
            {
                ...
                queryProperties.Add(new QueryParameter1(link, propertyName, propertyValue.Value, opr));
            }
            else
            {
    ...
    /// </summary>
    internal class QueryParameter1
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryParameter1" /> class.
        /// </summary>
        /// <param name="linkingOperator">The linking operator.</param>
        /// <param name="propertyName">Name of the property.</param>
        /// <param name="propertyValue">The property value.</param>
        /// <param name="queryOperator">The query operator.</param>
        internal QueryParameter1(string linkingOperator, string propertyName, object propertyValue, string queryOperator)
        {
